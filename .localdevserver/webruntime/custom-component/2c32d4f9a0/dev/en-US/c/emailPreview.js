Webruntime.define('lwc/emailPreview', ['lwc', 'lightning/configProvider', 'lightning/navigation'], function (lwc, configProvider, navigation) { 'use strict';

    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".padded" + shadowSelector + " {margin: 15px;}\n.bordered" + shadowSelector + " {border: 1px solid #666;}\n.centered" + shadowSelector + " {text-align: center;}\n";
    }
    ...
    **/
    ...
    function tmpl$c($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 0,
        on: {
          "click": _m0 || ($ctx._m0 = api_bind($cmp.openPreview))
        }
      }, []), api_element("div", {
        classMap: {
          "padded": true
        ...
        props: {
          "name": "progress",
          "label": "Customer Data Preview",
          "value": $cmp.value,
          "placeholder": "Select Data Extension Entry",
          "options": $cmp.options
        },
        key: 1,
        on: {
    ...
    class EmailPreview extends navigation.NavigationMixin(lwc.LightningElement) {
      constructor(...args) {
        super(...args);
        this.value = 'Frank';
      }
      ...
      get options() {
        return [{
          label: 'ID 14123: Frank Caron',
          value: 'Frank'
        }, {
          label: 'ID 12321: Jon Simms',
          value: 'Jon'
        }, {
          label: 'ID 51323: Tony Dotson',
          value: 'Tony'
        }];
      }
