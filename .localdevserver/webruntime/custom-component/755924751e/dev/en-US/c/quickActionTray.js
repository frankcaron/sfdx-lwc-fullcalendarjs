Webruntime.define('lwc/quickActionTray', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';

    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return "h1" + shadowSelector + " {line-height: 40px;width: 500px;}\n";
    }
    ...
    **/
    ...
    function tmpl$5($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 2
      }, [api_text("Hello "), api_dynamic($cmp.placeholderVar), api_text("!")])])])];
    }
    ...
    tmpl$5.stylesheetTokens = {
      hostAttribute: "lwc-quickActionTray_quickActionTray-host",
      shadowAttribute: "lwc-quickActionTray_quickActionTray"
    };

    class QuickActionTray extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.placeholderVar = `world, you're looking mighty fine this October the ${new Date().getDate()}th`;
      }

    }

    lwc.registerDecorators(QuickActionTray, {
      fields: ["placeholderVar"]
    });

    var quickActionTray = lwc.registerComponent(QuickActionTray, {
      tmpl: _tmpl$6
    });

    return quickActionTray;
