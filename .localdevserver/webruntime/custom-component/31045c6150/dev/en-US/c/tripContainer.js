Webruntime.define('lwc/tripContainer', ['lwc'], function (lwc) { 'use strict';
    ...
    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".trip-container" + shadowSelector + " {width: 100%;border: 0px;padding: 0px;background-color: #fff;}\n.trip-card" + shadowSelector + " {display: flex;width: 100%;min-width: 250px;min-height: 200px;background-color: #fff;box-shadow: 5px 10px 8px 10px #000;align-items: center;justify-content: center;}\n.trip-content" + shadowSelector + " {display: flex;flex-direction: column;flex-wrap: nowrap;}\n";
    }
