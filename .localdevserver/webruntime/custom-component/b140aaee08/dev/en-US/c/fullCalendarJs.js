Webruntime.define('lwc/fullCalendarJs', ['lwc'], function (lwc) { 'use strict';
  ...
  var FullCalendarJS = '/assets/project/0dd62237a0/staticresources/FullCalendarJS';
  ...
  class FullCalendarJs extends lwc.LightningElement {
    ...
    renderedCallback() {
      ...
      console.log("All good so far in the Community"); // Executes all loadScript and loadStyle promises
